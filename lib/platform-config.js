...
export const platformConfigs = {
  school: {
    ...
    categories: [
      ...
      { name: "pelecehan", icon: "Hand", description: "Laporan pelecehan verbal, fisik, atau digital yang perlu penanganan sensitif.", sensitive: true },
  ...
  campus: {
    ...
    categories: [
      ...
      { name: "pelecehan", icon: "Hand", description: "Laporan pelecehan di lingkungan kampus, termasuk kasus verbal, fisik, atau online.", sensitive: true },
  ...
  community: {
    ...
    categories: [
      ...
      { name: "pelecehan", icon: "Hand", description: "Laporan pelecehan atau tindakan tidak pantas di lingkungan warga atau perumahan.", sensitive: true },
  ...
  boarding_house: {
    ...
    categories: [
      ...
      { name: "pelecehan", icon: "Hand", description: "Laporan pelecehan, gangguan privasi, atau perilaku tidak aman di area kost.", sensitive: true },
  ...
  office: {
    ...
    categories: [
      ...
      { name: "pelecehan", icon: "Hand", description: "Laporan pelecehan, intimidasi, atau perilaku tidak pantas di lingkungan kerja.", sensitive: true },
  ...
  custom: {
    ...
    categories: [
      ...
      { name: "pelecehan", icon: "Hand", description: "Laporan pelecehan atau tindakan tidak pantas yang butuh jalur penanganan aman.", sensitive: true },
...
export function getCategoryConfig(type, categoryName) {
  const normalized = String(categoryName || "").trim().toLowerCase();
  return getPlatformConfig(type).categories.find((item) => item.name.toLowerCase() === normalized) || null;
}

export function isSensitiveCategoryForType(type, categoryName) {
  return Boolean(getCategoryConfig(type, categoryName)?.sensitive);
}
